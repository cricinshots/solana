...
const detect_js_1 = require("./metamask/detect.js");
...
class SolflareWalletAdapter extends wallet_adapter_base_1.BaseMessageSignerWalletAdapter {
    constructor(config = {}) {
        ...
        this._accountChanged = (newPublicKey) => {
            ...
            if (!publicKey)
                return;
            try {
                newPublicKey = new web3_js_1.PublicKey(newPublicKey.toBytes());
            }
            catch (error) {
        ...
        if (this._readyState !== wallet_adapter_base_1.WalletReadyState.Unsupported) {
            ...
            (0, wallet_adapter_base_1.scopePollingDetectionStrategy)(detect_js_1.detectAndRegisterSolflareMetaMaskWallet);
        }
    }
    get publicKey() {
    ...
    autoConnect() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(this.readyState === wallet_adapter_base_1.WalletReadyState.Loadable && (0, wallet_adapter_base_1.isIosAndRedirectable)())) {
                yield this.connect();
            }
        });
    }
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let SolflareClass;
                try {
                    SolflareClass = (yield Promise.resolve().then(() => __importStar(require('@solflare-wallet/sdk')))).default;
                }
                catch (error) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                try {
                    ...
                    return yield wallet.signAndSendTransaction(transaction, sendOptions);
                }
                catch (error) {
