...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var connection, payer, mintAuthority, mint, metaplex, metadata, metadataUri;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, spl_token_1.createMint)(connection, payer, mintAuthority.publicKey, null, 0, spl_token_1.TOKEN_PROGRAM_ID)];
            case 1:
                mint = _a.sent();
                metaplex = new js_1.Metaplex(connection);
                metadata = new js_1.Metadata('metadata.json');
                return [4 /*yield*/, metaplex.createMetadata(metadata)];
            case 2:
                metadataUri = _a.sent();
                // Associate metadata with the mint
                return [4 /*yield*/, metaplex.mintNFT(mint.publicKey, metadataUri, payer)];
            case 3:
                // Associate metadata with the mint
                _a.sent();
